...
public class SetServicePublished
{
    private readonly IServiceCatalogService _serviceCatalog;

    public SetServicePublished(IServiceCatalogService serviceCatalog)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        var result = await _serviceCatalog.SetPublishedAsync(id, body, cancellationToken);
